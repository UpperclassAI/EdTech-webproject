...
//       // Navigate to search results or filter courses based on query
//       navigate(`/dashboard/search?q=${encodeURIComponent(searchQuery)}`);
//       // You could also implement a search function here
...
//               {searchQuery && (
//                 <div className={`absolute top-full left-0 right-0 mt-1 rounded-lg shadow-lg z-50 border ${
//                   theme === "dark" 
...
//                     }`}>
//                       Quick suggestions for "{searchQuery}"
//                     </div>
//                     {[
//                       `Search for "${searchQuery}" in courses`,
//                       `Search for "${searchQuery}" in assignments`,
//                       `Search for "${searchQuery}" in materials`,
...
//                 className={`p-2 rounded-full transition-all duration-300 hover:scale-105 relative ${
//                   theme === "dark" 
...
//           theme === "dark" ? "text-gray-400" : "text-gray-600"
//         }`}>
//           <span className="cursor-pointer hover:text-blue-500">Dashboard</span>
...
//             <div className={`w-full max-w-4xl mx-4 rounded-xl shadow-2xl ${
...
//                     Search functionality would display results here
//                   </p>
//                 </div>
//               </div>
//             </div>
