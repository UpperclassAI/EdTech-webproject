...
export default function About() {
  return (
    <div className="w-full min-h-screen bg-gray-50">
      ...
      >
        <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-xl p-20 text-center">
          <h2 className="text-4xl font-bold text-blue-600 mb-4">
            About Upperclass AI
          </h2>

          <p className="text-black max-w-3xl p-8 mx-auto">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-6 flex-wrap">
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-4 rounded-full font-semibold transition">
              Join as a Student
            </button>

            <button className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 px-10 py-4 rounded-full font-semibold transition">
              Partner With Us
            </button>
          </div>
        </div>
      ...
      <motion.section
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="max-w-6xl mx-auto px-9 py-20 grid md:grid-cols-3 gap-8"
      >
      ...
      <section className="relative py-32 text-white bg-[url('/assets/ghj.png')] bg-cover bg-center">
      ...
      <section className="py-28 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <motion.div variants={fadeLeft} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <h3 className="text-4xl font-extrabold text-blue-600 mb-12">Our Journey</h3>

            <div className="relative border-l-4 border-blue-200 pl-10 space-y-16">
      ...
      >
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h3 className="text-4xl font-extrabold mb-6">This is just the beginning.</h3>
          ...
          <button className="bg-white text-blue-900 px-12 py-4 rounded-full font-semibold hover:scale-105 transition">
            Get Started
          </button>
        </div>
      </motion.section>
      ...
      {/* TEAM */}
      <motion.section variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="bg-white py-24">
        <div className="max-w-6xl mx-auto px-6 text-center mb-12">
          <h3 className="text-3xl font-bold text-blue-600">Meet Our Team</h3>
          <p className="text-gray-500 mt-2">The people building the future of learning</p>
        </div>
        <TeamCarousel />
      </motion.section>
...
function UniqueCard({ icon, title, text }) {
  return (
    <motion.div
      variants={fadeUp}
      className="bg-white/10 backdrop-blur-xl rounded-3xl p-10 text-center shadow-xl border-r-2  hover:-translate-y-2 transition"
    >
      <div className="w-16 h-16 mx-auto flex items-center justify-center rounded-full bg-white/20 mb-6">
        {icon}
      </div>
...
function JourneyStep({ year, title }) {
  return (
    <motion.div variants={fadeUp} className="relative">
      <div className="absolute -left-[42px] top-1 w-6 h-6 rounded-full bg-blue-600 border-4 border-white" />
...
function InfoCard({ title, text, active }) {
  return (
    <motion.div
      variants={fadeUp}
      className={`rounded-3xl p-10 min-h-[260px] shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 ${active ? "bg-blue-600 text-white" : "bg-white"}`}
    >
      <h3 className="font-extrabold text-2xl mb-4">{title}</h3>
      <p className={`text-base leading-relaxed ${active ? "text-blue-100" : "text-gray-600"}`}>{text}</p>
    </motion.div>
  );
}
