...
//           <div className=" rounded-xl bold flex items-center px-4 py-2 gap-19 shadow-md">
...
//           <div className="flex items-center gap-6 rounded-xl px-4 py-2 shadow-md bg-black/20">
//             {[
//               { path: "/", label: "Home" },
//               { path: "/courses", label: "Courses" },
//               { path: "/pricing", label: "Pricing" },
...
export default function Navbar() {
  ...
  return (
    <nav className="w-full fixed top-0 left-0 z-50 bg-transparent text-xl">
      <div className="max-w-7xl mx-auto px-9 py-4 flex justify-between items-center relative gap-9">
